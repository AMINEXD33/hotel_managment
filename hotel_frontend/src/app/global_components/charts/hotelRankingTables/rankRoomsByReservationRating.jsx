...
import { API_classedRoomsByReservationsRatings, API_getHotelsLite } from "../../../../../endpoints/endpoints";
...
export default function RankRoomsByReservationRating({}) {
  ...
  useEffect(() => {
    ...
    let promises = massCall([
      { url: API_classedRoomsByReservationsRatings(), method: "POST", body:{"hotel_id": hotelSelected}},
    ]);
    promises
      .then(async (promises) => {
